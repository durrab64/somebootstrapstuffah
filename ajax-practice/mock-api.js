...
(function () {
  ...
  console.log("%cMock API Interceptor Loaded!", "color: #6366f1; font-weight: bold; font-size: 1.1em;");
  console.log("Mocked routes active:", [
    "/api/check-stock?id=prod_1024",
    "/validate-username?username=...",
    "/api/posts?page=X",
    "/get-models?make=...",
    "/api/weather?status=[offline|500|404|ok]",
    "/api/like (POST + X-CSRF-Token)"
  ]);
})();
